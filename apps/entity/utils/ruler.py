...
patterns.extend(dni)
patterns.extend(telefonos)
patterns.extend(ips)
patterns.extend(fecha_numerica)
patterns.extend(cuij)
patterns.extend(fecha)
patterns.extend(nacionalidad)
patterns.extend(bancos)
patterns.extend(patentes)
patterns.extend(estudios)
patterns.extend(marcas_autos)
